...
import com.Fazrin.LampeR.HistoryActivity;
import com.Fazrin.LampeR.Login.LauncherActivity;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    if(map.get("name")!=null){
                        mCustomerName.setText(getResources().getString(R.string.ride_name) + map.get("name").toString());
                    }
                    if(map.get("phone")!=null){
                        mCustomerPhone.setText(getResources().getString(R.string.ride_phone) + map.get("phone").toString());
                    }
